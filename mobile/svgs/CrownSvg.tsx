...
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 267.5 267.5" style="fill:#E5EBED;" style="enable-background:new 0 0 267.5 267.5;" xml:space="preserve">
<path style="fill:#E5EBED;" d="M256.975,100.34c0.041,0.736-0.013,1.485-0.198,2.229l-16.5,66c-0.832,3.325-3.812,5.663-7.238,5.681l-99,0.5
...
export default function CrownSvg() {
  const CrownSvgFunc = () => <SvgXml xml={xml} width={40} height={40} />;
  return <CrownSvgFunc />;
}
